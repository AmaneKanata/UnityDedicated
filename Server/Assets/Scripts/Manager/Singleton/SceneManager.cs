...
public class SceneManager : SingletonManager<SceneManager>
{
    ...
    {
        return UnityEngine.SceneManagement.SceneManager.GetSceneByName(_sceneName).isLoaded;
    }
    ...
    {
        Scene scene = UnityEngine.SceneManagement.SceneManager.GetSceneByBuildIndex(_buildIndex);
